...
#' @param env The environment in which to create the variables. Default is global
#'
#' @return Variables for lazy connections to each of the tables in the global environment
#'
#' @export
#'
#'
lazy_conn_all_tables <- function(pool_conn,schemaname = "public", prefix = "", env = globalenv()){
  ...
  # Create variable in the global environment
